...
void afficherStats(unsigned int nbrSecondesDepuisDemarrage,
  ...
  printf("| %-40s| %-30s|\n", "Champ", "Valeur");
  printf("%s\n", lineBuf);
  printf("| %-40s| %-30u|\n", "Nombre de requetes en attente",
         stats->nombreRequetesEnAttente);
  printf("| %-40s| %-30u|\n", "Nombre de requetes traitees",
         stats->nombreRequetesTraitees);
  printf("| %-40s| %-30u|\n", "Nombre de requetes perdues",
